...
function fakeStore(opts: {
  ...
  return {
    ...
    updateAlertState,
    saveDriftReport: notImplemented("saveDriftReport"),
    getDriftReport: notImplemented("getDriftReport"),
    listDriftReports: notImplemented("listDriftReports"),
    deleteDriftReport: notImplemented("deleteDriftReport"),
